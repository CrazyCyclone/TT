public class CreditCard {
    ...
    private final String account;     // account identifier (e.g., ”5391 0375 9387 5309”)
    private final int limit;          // credit limit (measured in dollars)
    ...
    public static void printSummary(CreditCard card) {
        ...
        System.out.println("Limit = " + card.getLimit());         // implicit cast
    }
}
